...
class Dictionaries(BaseModel):
    ...
    follow_up_result: list[str]
    follow_up_satisfaction: list[str]
...
def get_dictionaries() -> Dictionaries:
    return Dictionaries(
        ...
        follow_up_result=[item.value for item in FollowUpResult],
        follow_up_satisfaction=[item.value for item in FollowUpSatisfaction],
